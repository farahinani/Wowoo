...
<body class="animsition">
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="kyc">
                                <i class="far fa-check-square"></i>KYC Info</a>
                        </li>
                        <li>
                            <a href="wallet">
                                <i class="fas fa-calendar-alt"></i>Wallet</a>
                        </li>
                        <li>
                            <a href="evangelist">
                                <i class="fas fa-map-marker-alt"></i>Evangelist</a>
                        </li>
                        
                        <li>
                            <a href="bounty">
                                <i class="fas fa-chart-bar"></i>Bounty</a>
                        </li>
	...
	<script src="${js}/adminLTE/jquery-3.2.1.min.js"></script>
	<!-- Bootstrap JS-->
